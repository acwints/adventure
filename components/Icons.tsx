...
export const CompassIcon: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
...
export const PlayIcon: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    style={style}
...
export const StopIcon: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    style={style}
...
export const LoadingSpinner: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    style={{ 
...
export const MagicWandIcon: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    style={style}
...
export const GoogleIcon: React.FC<IconProps> = ({ className, style, size = 24 }) => (
  <svg 
    className={className}
    style={style}
    width={size}
